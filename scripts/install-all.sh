...
printf '    player: one lane per channel under a measured time ruler, the min/max\n'
printf '    envelope with the RMS band inside it, a linear or dBFS scale, zoom from\n'
